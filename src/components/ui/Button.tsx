...
const baseStyles = {
  ...
  outline:
    'group inline-flex items-center justify-center rounded-lg py-2 px-4 text-sm focus:outline-none font-semibold focus-visible:outline-2 focus-visible:outline-offset-2',
};
